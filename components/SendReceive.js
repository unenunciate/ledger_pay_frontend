            ...
            <Tab.Panels>
                  ...
                  <div className="flex flex-col items-center justify-center w-full p-4 h-[75vh] pt-8">
                    ...
                    <div className="flex flex-col items-center justify-center w-full -mb-8 space-y-4 h-1/2">
                      ...
                      <div className="flex flex-col space-y-2">
                        <label className="h-full py-2 text-center text-blue-400 bg-gray-700 rounded-lg w-36">
                          To
                        </label>
                        <input
              ...
              <Tab.Panel>
                <div className="flex flex-col items-center justify-start w-full min-h-screen p-4">
                  <div className="flex flex-col items-center justify-between w-full p-4 h-[60vh] pt-8">
                    <div className="flex flex-col items-center justify-center w-full space-y-4 h-1/4">
                      <Listbox
                        value={selectedNetwork}
                        onChange={setSelectedNetwork}
                      >
                    ...
                    <div className="p-4 bg-white rounded-lg">
                      <QRCode value="0x0003a0304024120014104144cdcadaddada" />
                    </div>
                  </div>
                </div>
              </Tab.Panel>

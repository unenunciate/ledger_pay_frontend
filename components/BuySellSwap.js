...
import { buyCrypto } from "../utils/queries/buysellswap";
...
const cryptos = [
  ...
  { id: 1, name: "ETH", icon: { url: "/eth.png" } },
  { id: 2, name: "USDC", icon: { url: "/USDC.png" } },
];

const networks = [{ id: 0, name: "Polygon", icon: { url: "/polygon.png" } }];

const exchanges = [{ id: 0, name: "SushiSwap", icon: { url: "/sushi.png" } }];

const paymentMethods = [
  { id: 0, nickname: "xxxx xxxx xxxx 1881", icon: { url: "/visa.png" } },
  { id: 1, nickname: "VISA ending in 0111", icon: { url: "/visa.png" } },
];
        ...
        <div className="relative flex flex-col items-center justify-between w-full min-h-screen py-6 text-blue-400 bg-gray-800">
          ...
          >
            ...
            >
              <Tab
                as="button"
                className="flex items-center justify-center w-1/3 py-2 rounded-lg cursor-pointer ui-selected:font-bold ui-selected:bg-gray-900"
              >
                <span>Buy</span>
              </Tab>
              <Tab
                ...
                <div className="flex flex-col items-center justify-center w-full min-h-screen p-4">
                  <div className="flex flex-col items-center justify-center w-full p-4 h-[75vh] pt-8">
                    <div className="flex flex-row items-center justify-around w-48 mb-8 h-1/4">
                      ...
                      <input
                        className="w-24 h-full px-2 text-3xl text-purple-600 placeholder-purple-600 bg-gray-800 border-none form-input focus:border-none focus:outline-none"
                        placeholder="0"
                        type="number"
                        value={dollarAmount}
                    ...
                    <div className="flex flex-col items-center justify-center w-full -mb-8 space-y-4 h-1/2">
                      ...
                      >
                        <div className="relative flex flex-col mt-1 space-y-2">
                          <Listbox.Label className="h-full py-2 text-center bg-gray-700 rounded-lg w-36">
                            Buying
                          </Listbox.Label>
                          <Listbox.Button className="relative flex items-center w-full py-2 pl-3 pr-10 text-left bg-gray-700 rounded-lg cursor-default focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-purple-600 sm:text-sm">
                            <Image
                              src={selectedCrypto.icon.url}
                              width={16}
                              height={16}
                              layout="fixed"
                            />
                            <span className="flex ml-3 truncate">
                              {selectedCrypto.name}
                            </span>
                      ...
                      >
                        <div className="relative flex flex-col mt-1 space-y-2">
                          <Listbox.Label className="h-full py-2 text-center bg-gray-700 rounded-lg w-64">
                            Payment Method
                          </Listbox.Label>
                          <Listbox.Button className="relative flex items-center w-full py-2 pl-3 pr-10 text-left bg-gray-700 rounded-lg cursor-default focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-purple-600 sm:text-sm">
                            <Image
                              src={selectedPaymentMethod.icon.url}
                              width={16}
                              height={16}
                              layout="fixed"
                            />
                      ...
                      <button
                        onClick={() =>
                          buyCrypto({
                            amount: dollarAmount,
                            sourceCurrency: "USD",
                            destCurrency: selectedCrypto.name,
                            dest: "0x9E01E0E60dF079136a7a1d4ed97d709D5Fe3e341",
                          })
                        }
                ...
                <div className="flex flex-col items-center justify-center w-full min-h-screen p-4">
                  <div className="flex flex-col items-center justify-center w-full p-4 h-[75vh] pt-8">
                    ...
                    <div className="flex flex-col items-center justify-center w-full -mb-8 space-y-4 h-1/2">
                      ...
                      <Listbox
                        value={selectedForCrypto}
                        onChange={setSelectedForCrypto}
                      >
                        <div className="relative flex flex-col mt-1 space-y-2">
                          <Listbox.Label className="h-full py-2 text-center bg-gray-700 rounded-lg w-36">
                            For
                          ...
                          <Listbox.Button className="relative flex items-center w-full py-2 pl-3 pr-10 text-left bg-gray-700 rounded-lg cursor-default focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-purple-600 sm:text-sm">
                            <Image
                              src={selectedForCrypto.icon.url}
                              width={16}
                              height={16}
                              layout="fixed"
                            />
                            <span className="flex ml-3 truncate">
                              {selectedForCrypto.name}
                            </span>
                            <span className="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none">
                              <ChevronUpDownIcon
                                className="w-5 h-5 text-gray-400"

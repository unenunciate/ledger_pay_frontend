...
const SmartAccountProvider = ({children}) => {
    ...
    const [SmartAccountAPI] = useMemo(() => SmartAccountProvider && SmartAccountSigner ? new SimpleWalletAPI(SmartAccountProvider, ClientConfig.entryPointAddress, SmartAccountAddress, SmartAccountSigner, address) : null, [SmartAccountProvider, SmartAccountSigner]);
    ...
    return (
        <SmartAccountContext.Provider value={{SmartAccountSigner, SmartAccountProvider, SmartAccountAPI, SmartAccountRPC, SmartAccountAddress}} >
            {children}

...
export declare class UserOperationEventListener {
    ...
    constructor(resolve: (t: TransactionReceipt) => void, reject: (reason?: any) => void, entryPoint: EntryPoint, sender: string, requestId: string, nonce?: BigNumberish | undefined, timeout?: number | undefined);
    start(): void;
    stop(): void;
